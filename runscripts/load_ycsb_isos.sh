...
rm -f "/home/ubuntu/benchmark_out/ycsb_${BENCHMARK_NAME}/ycsb_l_${BENCHMARK_NAME}_${CLIENT_ID}.raw"
...
java -Djava.security.properties="./config/java.security" \
  ...
  -p measurement.raw.output_file="/home/ubuntu/benchmark_out/ycsb_${BENCHMARK_NAME}/ycsb_l_${BENCHMARK_NAME}_${CLIENT_ID}.raw" \
