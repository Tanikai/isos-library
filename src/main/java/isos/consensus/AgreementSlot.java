...
public record AgreementSlot(
        ...
        Map<SequenceNumber, DepVerifyMessage> depVerifies, // v[f_i]: DepVerify  for slot s_j from follower f_i
        AgreementSlotPhase step, // current phase
        ViewNumber viewNumber, // View number for slot s_j, initially -1
        Map<ReplicaId, ViewNumber> peerViewNumbers, // Highest view number for slot s_j seen for replica r_i
        // certificate
        ) {
