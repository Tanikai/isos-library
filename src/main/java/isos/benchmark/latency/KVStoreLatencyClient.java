...
import isos.benchmark.kvstore.bftsmart.BFTSMaRtKVStoreClient;
...
public class KVStoreLatencyClient {
  ...
  private final BFTSMaRtKVStoreClient<String, String> client;
  ...
  public KVStoreLatencyClient(int clientId, int writeRatioPercent, int conflictRatioPercent) {
    ...
    this.client = new BFTSMaRtKVStoreClient<>(clientId);
   ...
   */
  public long executeRequest(String key, String value) throws TimeoutException {
