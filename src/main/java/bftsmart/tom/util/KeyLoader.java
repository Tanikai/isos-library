 ...
 * Developers can use implementations of this interface so that if their application uses key
 * structures similar to the library, these keys can be shared by both the library and the
 * application to simplify key management.
 */
public interface KeyLoader {
   ...
   * @throws NoSuchAlgorithmException If the algorithm specified in the configuration does not
   *     exist.
   ...
   */
  PublicKey loadPublicKey(int id)
