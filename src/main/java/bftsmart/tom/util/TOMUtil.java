...
public class TOMUtil {
  ...
  public static boolean verifySigForBenchmark(
      Signature initializedSignatureEngine, byte[] message, byte[] signature) {
  ...
  public static Signature getSigEngine() throws NoSuchAlgorithmException {
    ...
    return Signature.getInstance(
        TOMUtil.sigAlgorithm, Security.getProvider(TOMUtil.sigAlgorithmProvider));
  }

  public static MessageDigest getHashEngine() throws NoSuchAlgorithmException {

    return MessageDigest.getInstance(
        TOMUtil.hashAlgorithm, Security.getProvider(TOMUtil.hashAlgorithmProvider));
  }

  public static SecretKeyFactory getSecretFactory() throws NoSuchAlgorithmException {

    return SecretKeyFactory.getInstance(
        TOMUtil.secretAlgorithm, Security.getProvider(TOMUtil.secretAlgorithmProvider));
  }
