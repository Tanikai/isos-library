...
/**
 * Executables that implement this interface can received unordered client requests. To support
 * ordered requests, objects that implement this interface must also implement either
 * 'FIFOExecutable', 'BatchExecutable' or 'SingleExecutable'.
 */
public interface Executable {
   ...
   *
   * The message context contains some useful information such as the command sender.
   *
  ...
  default TOMMessage getTOMMessage(
      int processID, int viewID, byte[] command, MessageContext msgCtx, byte[] result) {
  ...
  default TOMMessage executeUnordered(
