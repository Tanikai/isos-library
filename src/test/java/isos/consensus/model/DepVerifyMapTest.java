...
class DepVerifyMapTest {
  ...
  void testMinimumDependencyOccurrence_AllDependenciesMeetMinCount() {
    SequenceNumber dep1 = SequenceNumber.of(1, 1);
    SequenceNumber dep2 = SequenceNumber.of(2, 2);
    DependencySet set1 = new DependencySet(Set.of(dep1, dep2));
    DependencySet set2 = new DependencySet(Set.of(dep1, dep2));
    DepVerifyMessage msg1 = new DepVerifyMessage(SequenceNumber.of(1, 0), ReplicaId.of(1), "hash", set1);
    DepVerifyMessage msg2 = new DepVerifyMessage(SequenceNumber.of(2, 0), ReplicaId.of(2), "hash", set2);
