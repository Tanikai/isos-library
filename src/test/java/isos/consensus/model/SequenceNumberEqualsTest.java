...
class SequenceNumberEqualsTest {
  ...
  void testEqualsSameValues() {
    SequenceNumber sn1 = SequenceNumber.of(1, 42);
    SequenceNumber sn2 = SequenceNumber.of(1, 42);
  ...
  void testNotEqualsDifferentReplicaId() {
    SequenceNumber sn1 = SequenceNumber.of(1, 42);
    SequenceNumber sn2 = SequenceNumber.of(2, 42);
  ...
  void testNotEqualsDifferentSequenceCounter() {
    SequenceNumber sn1 = SequenceNumber.of(1, 42);
    SequenceNumber sn2 = SequenceNumber.of(1, 43);
    assertNotEquals(sn1, sn2);
    assertNotEquals(sn2, sn1);
  }
  ...
  void testEqualsItself() {
    SequenceNumber sn = SequenceNumber.of(5, 99);
    assertEquals(sn, sn);
  }
